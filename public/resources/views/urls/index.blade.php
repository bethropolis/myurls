...
@section('content')
    <div class="max-w-full mx-auto my-8">
        ...
        <div class="mb-4">
            <a href="{{ route('urls.create') }}" class="px-4 py-2 mx-2 text-white bg-pink-500 hover:bg-purple-500 
            transition duration-300 rounded-b-lg rounded-t-md ">Create URL</a>
        </div>
